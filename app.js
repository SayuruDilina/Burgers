...
function addBeverage() {
    ...
    const Qty = document.getElementById("addQtyBeverage").value;

    const BeverageData = JSON.parse(localStorage.getItem('Beverages')) || [];
    const newItem = { itemCode, itemName, price, discount: discount || "-", Qty };
...
function addChicken() {
    ...
    const Qty = document.getElementById("addQtyChicken").value;
...
function addSubmarine() {
    ...
    const Qty = document.getElementById("addQtySub").value;
...
function addFries() {
    ...
    const Qty = document.getElementById("addQtyFry").value;
...
function addPasta() {
    ...
    const Qty = document.getElementById("addQtyPasta").value;
